...
<main class="container">
    <div class="d-flex align-items-center p-3 my-3 text-white bg-purple rounded shadow-sm">
      ...
      {{-- <img class="me-3" src="{{asset('svg/logo.svg')}}" alt="SVG Image" width="48" height="38"> --}}
      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-browser-safari" viewBox="0 0 16 16">
      ...
      <div class="lh-1 pl-6">
        <h1 class="h6 mb-0 text-white lh-1">合作单位</h1>
        <small>浙江财经大学东方学院</small>
      </div>
      <div class="ml-auto">
        <a href="/companies/create" class="btn btn-primary btn-sm">添加合作单位</a>

      </div>
    </div>

    <div class="my-3 p-3 bg-body rounded shadow-sm">
      <h6 class="border-bottom pb-2 mb-0">单位列表</h6>
      @foreach ($companies as $company)
      <div class="d-flex text-body-secondary pt-3">
        <svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#007bff"></rect><text x="50%" y="50%" fill="#007bff" dy=".3em">32x32</text></svg>
        <p class="pb-3 mb-0 small lh-sm border-bottom">
          <strong class="d-block text-gray-dark">{{$company->user->name}}</strong>
