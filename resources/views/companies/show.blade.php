    ...
    <div class="py-5">
      ...
      <div class="col-lg-6 mx-auto">
        ...
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
          <a type="button" class="btn btn-outline-info btn-lg px-4 me-sm-3 fw-bold" href="{{route('projects.index')}}">Create Project</a>
  ...
  <div class="col-md-4">
    <div class="position-sticky" style="top: 2rem;">
      <div class="p-4 mb-3 bg-body-tertiary rounded">
        ...
        <ul class="p-4">
            <li class="p-1"><a href="/companies/{{$company->id}}/edit">Edit</a></li>
            <li class="p-1">
            <a href="#" onclick="
            ...
            <li class="p-1"><a href="{{route('companies.index')}}">Back</a></li>
        </ul>
       </div>
